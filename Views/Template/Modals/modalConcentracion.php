<!-- Modal -->
<div class="modal fade" id="modalFormConcentracion" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header headerRegister">
                <h5 class="modal-title" id="titleModal">Nueva Concentracion</h5>
            ...
            <div class="modal-body">
                <div class="tile">
                    <div class="tile-body">
                        <form id="formConcentracion" name="formConcentracion">
                            <input type="hidden" id="idConcentracion" name="idConcentracion" value="">
